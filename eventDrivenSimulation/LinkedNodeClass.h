...
// Purpose: This is the project 5 of EECS 402. This is the prototype
// of templated linked node class. 
  ...
  public:
    ...
    LinkedNodeClass(
         LinkedNodeClass< T > *inPrev, 
                                //Address of node comes before this one
         const T &inVal,        //Value to be contained in this node
         LinkedNodeClass< T > *inNext  //Address of node comes after this one
         );
